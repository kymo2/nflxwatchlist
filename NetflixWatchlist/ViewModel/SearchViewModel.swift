...
class SearchViewModel: ObservableObject {
    ...
    func fetchAvailability(for catalogItem: CatalogItem, countTowardsUsage: Bool = true, treatAsSaved: Bool = false) {
        let itemId = catalogItem.itemId
        let shouldTreatAsSaved = catalogItem.isSavedItem || treatAsSaved
        ...
        service.fetchCatalogItemAvailability(itemId: itemId, countTowardsUsage: countTowardsUsage) { [weak self] availability in
            guard let self = self else { return }
